package com.yangnan.crm.rbac.aspect;
...
public class LogAspect {
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, OperLog operLog, Object jsonResult, HttpServletRequest request) throws Exception {
        // 设置action动作
        operLog.setOperType(log.operType().name());
        // 设置标题
        ...
        if (log.isSaveResponseData() && !ObjectUtils.isEmpty(jsonResult)) {
            operLog.setJsonResult(new ObjectMapper().writeValueAsString(jsonResult));
        }
    }
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, OperLog operLog, HttpServletRequest request) throws Exception {
        ...
        if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod)) {
            ...
            operLog.setOperParam(new ObjectMapper().writeValueAsString(paramsMap));
        }
    }
        ...
        if (paramsArray != null && paramsArray.length > 0) {
            for (Object o : paramsArray) {
                if (!ObjectUtils.isEmpty(o) && !isFilterObject(o)) {
                    try {
                        params += new ObjectMapper().writeValueAsString(o) + " ";
                    } catch (Exception e) {
                    }
                }
            }
